    ...
    Gas: TxGas<Env>,
{
    pub fn setup_mystery_box<
        Arg0: ProxyArg<MultiValueEncoded<Env::Api, MultiValue6<RewardType, RewaOrDcdtTokenIdentifier<Env::Api>, BigUint<Env::Api>, ManagedBuffer<Env::Api>, u64, u64>>>,
    >(
        self,
    ...
    Api: ManagedTypeApi,
{
    ...
    pub reward_token_id: RewaOrDcdtTokenIdentifier<Api>,
