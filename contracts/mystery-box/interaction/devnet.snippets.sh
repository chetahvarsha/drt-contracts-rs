...
MB_WASM_PATH="~/drt-contracts-rs/contracts/mystery-box/output/mystery-box.drtsc.json"
...
## DCDT manager address: drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls6prdez
## Transfer createRole
