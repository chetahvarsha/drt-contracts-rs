...
use ping_pong_rewa_interact::{Config, PingPongRewaInteract};

#[tokio::test]
#[cfg_attr(not(feature = "chain-simulator-tests"), ignore)]
async fn test_ping_pong_rewa() {
    let mut interact = PingPongRewaInteract::init(Config::chain_simulator_config()).await;
    ...
    interact
        .deploy(
            ...
            dharitri_sc_snippets::imports::OptionalValue::Some(max_funds.into()),
        )
        .await;
