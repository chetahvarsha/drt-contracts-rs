    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn unlock<
        Arg0: ProxyArg<ManagedVec<Env::Api, DcdtTokenPayment<Env::Api>>>,
    >(
        self,
        tokens: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
    ...
    >(
        self,
        address: Arg0,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedVec<Env::Api, DcdtTokenPayment<Env::Api>>> {
        self.wrapped_tx
            .payment(NotPayable)
...
where
    Api: ManagedTypeApi,
{
    pub token: DcdtTokenPayment<Api>,
