...
The release version v0.45.5 of drt-contracts-rs, contains the audited of for the multisig contract. It can be found here: https://github.com/dharitri/drt-contracts-rs/releases/tag/v0.45.5
