use dharitri_sc::{codec::top_encode_to_vec_u8_or_panic, types::BigUint};
...
impl MultisigTestState {
    ...
    fn propose_transfer_execute(
        ...
        self.world
            ...
            .to(MULTISIG_ADDRESS)
            .typed(multisig_proxy::MultisigProxy)
            .propose_transfer_execute(to, rewa_amount, Option::<GasLimit>::None, contract_call)
            .returns(ReturnsResult)
            .run()
    }
    ...
    fn propose_async_call(
        ...
        self.world
            ...
            .to(MULTISIG_ADDRESS)
            .typed(multisig_proxy::MultisigProxy)
            .propose_async_call(to, rewa_amount, Option::<GasLimit>::None, contract_call)
            .returns(ReturnsResult)
            .run()
    }
...
fn test_transfer_execute_batch() {
    ...
    let action_id = multisig_proxy::Action::SendTransferExecuteRewa(call_data);
