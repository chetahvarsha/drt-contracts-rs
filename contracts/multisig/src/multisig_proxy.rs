    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn propose_transfer_execute_dcdt<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<ManagedVec<Env::Api, DcdtTokenPayment<Env::Api>>>,
        Arg2: ProxyArg<Option<u64>>,
        Arg3: ProxyArg<FunctionCall<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("proposeTransferExecuteDcdt")
            .argument(&to)
            .argument(&tokens)
            .argument(&opt_gas_limit)
            .argument(&function_call)
    ...
    Api: ManagedTypeApi,
{
    ...
    ChangeQuorum(usize),
    SendTransferExecuteRewa(CallActionData<Api>),
    SendTransferExecuteDcdt(DcdtTransferExecuteData<Api>),
...
#[type_abi]
#[derive(NestedEncode, NestedDecode, Clone)]
pub struct DcdtTransferExecuteData<Api>
where
    Api: ManagedTypeApi,
{
    pub to: ManagedAddress<Api>,
    pub tokens: ManagedVec<Api, DcdtTokenPayment<Api>>,
    pub opt_gas_limit: Option<u64>,
    pub endpoint_name: ManagedBuffer<Api>,
    pub arguments: ManagedVec<Api, ManagedBuffer<Api>>,
}
