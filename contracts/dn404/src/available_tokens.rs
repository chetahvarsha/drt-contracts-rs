...
use dharitri_sc::{api::ManagedTypeApi, derive_imports::*, imports::*, types::TokenIdentifier};
    ...
    + dharitri_sc_modules::only_admin::OnlyAdminModule
{
    ...
    fn deposit_basket_of_goods(&self) {
        ...
        for payment in &payments {
            ...
            let mut price_as_payment = DcdtTokenPayment::new(token_id.clone(), 0, price);
    ...
    fn claim_basket_of_goods(
        &self,
        tokens_to_claim: MultiValueEncoded<DcdtTokenPaymentMultiValue>,
    ) {
        self.require_not_paused();
        ...
        for token_to_claim in tokens_to_claim {
            let token_as_payment = token_to_claim.into_dcdt_token_payment();
        ...
        let remaining_tokens_payment = DcdtTokenPayment::new(payment_token, 0, remaining_tokens);
        self.tx()
            .to(ToCaller)
