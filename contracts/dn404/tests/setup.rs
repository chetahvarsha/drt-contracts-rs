...
use dharitri_sc::types::{
    DcdtLocalRole, MultiValueEncoded, TestAddress, TestDcdtTransfer, TestSCAddress,
    TestTokenIdentifier,
};
...
pub const CODE_PATH: DrtscPath = DrtscPath::new("output/dn404.drtsc.json");
...
impl Dn404Setup {
    pub fn new() -> Self {
        ...
        b_mock
            .account(OWNER)
            .nonce(1)
            .dcdt_nft_balance(NFT_TOKEN_ID, 5, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 6, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 7, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 8, 1, ());
        ...
        b_mock
            ...
            .code(CODE_PATH)
            .owner(OWNER)
            .dcdt_roles(FRACTAL_TOKEN_ID, roles);
        ...
        let transfers = vec![
            TestDcdtTransfer(NFT_TOKEN_ID, 5, 1),
            TestDcdtTransfer(NFT_TOKEN_ID, 6, 1),
            TestDcdtTransfer(NFT_TOKEN_ID, 7, 1),
            TestDcdtTransfer(NFT_TOKEN_ID, 8, 1),
        ];
        ...
        b_mock
            ...
            .typed(dn404_proxy::Dn404Proxy)
            .deposit()
            .multi_dcdt(transfers)
            .run();

        b_mock
            .account(FIRST_USER)
            .nonce(1)
            .dcdt_nft_balance(NFT_TOKEN_ID, 1, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 2, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 3, 1, ())
            .dcdt_nft_balance(NFT_TOKEN_ID, 4, 1, ());

        b_mock
            .account(SECOND_USER)
            .nonce(1)
            .dcdt_balance(FRACTAL_TOKEN_ID, USER_BALANCE);
