...
use dharitri_sc_scenario::{imports::DrtscPath, DebugApi, ScenarioTxWhitebox, ScenarioWorld};
...
const CODE_PATH: DrtscPath = DrtscPath::new("output/rewards-distribution.drtsc.json");
