...
*prize\_pool*: the accumulated dcdt tokens up until now.
...
All you need to do is pass along the name of the lottery you wish to purchase the ticket for and deposit the appropriate sum of the specific dcdt tokens, corresponding to the ticket cost.
