...
const PROXY_DEPLOYER_PATH_EXPR: DrtscPath = DrtscPath::new("output/proxy-deployer.drtsc.json");
const DEPLOYED_CONTRACT_PATH_EXPR: DrtscPath = DrtscPath::new("../adder/output/adder.drtsc.json");
