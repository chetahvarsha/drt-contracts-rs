...
pub trait OwnerModule: crate::private::PrivateModule + crate::storage::StorageModule {
        ...
        match game_settings.status {
            Status::Invalid => {
                ...
                self.tx()
                    ...
                    .rewa_or_single_dcdt(&token_id, 0, &game_creation_fee)
                    .transfer();
                ...
                match winners {
                    OptionalValue::Some(val) => {
                        ...
                        for (winner, percentage) in val.into_iter() {
                            ...
                            self.tx()
                                .to(winner)
                                .rewa_or_single_dcdt(&token_id, 0, &reward_per_winner)
                                .transfer();
                        }
                    }
                    //tie/draw
    ...
    #[only_owner]
    #[endpoint(setTokenId)]
    fn set_token_id(&self, token_id: RewaOrDcdtTokenIdentifier) {
